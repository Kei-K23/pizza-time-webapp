...
const PopUp = () => {
  ...
  const { setPopUp, quantity } = useContext(PopUpContext);
  ...
  const total = currentCrust?.price + currentTopping?.price;
    ...
    <div className="popup-layer">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <button className="sm-btn" onClick={handleClick}>
            Close
          </button>
          <button className="sm-btn" onClick={handleClickDownload}>
            <i className="fa-solid fa-download"></i> Download
          </button>
          <button className="sm-btn" onClick={handleClickFavourite}>
